# Yürek Yarası — Orijinal Sözler (Arabesk, Düet)
...
**Neden bu tema/format:** Günlük ana üretimin (5'lik) ilk şarkısı — arabeskte
...
```
Turkish arabesk-pop duet, dramatic and emotional, kanun and strings, deep 808 undertone, powerful belting female vocals alternating with warm raspy male vocals, bittersweet heartbreak atmosphere, 78 BPM
```
...
- Vokal dili: Türkçe ("powerful belting female vocals alternating with warm
  raspy male vocals" + Türkçe sözler).
- Vokal formatı: **düet** — hem kadın hem erkek vokal aynı şarkıda, ana kataloğun
  "art arda aynı cinsiyet tekrarlanmasın" kuralı bu şarkı için geçersiz (ikisi
  de var) — bir sonraki şarkı için alternasyon bu düetten SONRAKİ referans
  noktası olarak düşünülmeli.
