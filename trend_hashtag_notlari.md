...
NOT: `#SunoAI`/`#AIMusic`/`#YapayZekaMüzik`/`#AIMusicChallenge`/`#AIGeneratedMusic`
gibi AI-vurgulu ibareler bilerek listede/kullanımda YOK — kullanıcı kararı: hiçbir
üretimde (caption, YouTube tag, video içi kayan yazı) bu ibareler kullanılmasın.
ZORUNLU AI-üretimi bildirimi bundan ayrı bir mekanizma, hâlâ yerinde (bkz.
`config.py`'deki `BRAND_HASHTAGS` notu).
