# Kırık Zincir — Orijinal Sözler (Rock)
...
**Neden bu tema:** Günlük ana üretimin (5'lik) dördüncü şarkısı — Neon Kalp'in
(kadın) ardından erkeğe dönülüyor. `config.THEMES`'in 6 slotundan `rock`, kataloğun
şimdiye kadar HİÇ kullanmadığı tek temaydı (bkz. CLAUDE.md, `ses_ve_tarz_takibi.md`
geçmişi) — Türkiye trend araştırmasında düşük veri desteği olsa da (bkz.
`turkiye_muzik_trend_arastirmasi.md`), katalog çeşitliliği için ilk kez dolduruluyor.
...
- Vokal cinsiyeti: Neon Kalp'in (kadın) ardından erkeğe dönüldü.
