# Sabaha Kadar — Orijinal Sözler (Elektronik)
...
füzyonuna taşıyor — TikTok'ta kısa döngülü dans/edit içerikleri için uygun,
markada henüz denenmemiş bir ses ve görsel kimlik.

## Stil Etiketi (Suno Style kutusuna yapıştır)

```
Turkish organic house, warm analog synth pads, congas and shakers, uplifting emotional chant hook, female vocals, festival sunrise energy, 122 BPM
```
...
- Tema: özgürlük, gece-sabah geçişi, topluluk/festival enerjisi — Kalbim
  Oynuyor'la aynı "kutlama" ailesinde ama daha elektronik/club prodüksiyon
- `config.py`'deki `theme` alanı için: `"elektronik"` (accent camgöbeği/mor)
